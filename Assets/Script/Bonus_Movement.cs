...
public class Bonus_Movement : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        transform.Translate(new Vector3(randomPoint.x, randomPoint.y, 0).normalized * game_Chronometer.Get_Target_Speed() * Time.deltaTime, Space.World);
    }
}
